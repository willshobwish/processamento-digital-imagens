 ...
 * @author Willian
 */
public class OpenPPMFile extends javax.swing.JFrame {
    ...
    private void jFileChooser1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFileChooser1ActionPerformed
        ...
        Controlador.getInstance().abrirImagemPPM(jFileChooser1.getSelectedFile().getAbsolutePath());
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OpenPPMFile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
